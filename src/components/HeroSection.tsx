        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Button
              ...
              className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg glow-effect group relative overflow-hidden transition-all active:scale-95"
            >
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="border-border hover:bg-secondary px-8 py-6 text-lg transition-all active:scale-95"
            >
